webpackJsonp([1], {
    ...
    NHnr: function(t, e, i) {
        ...
        var A, P, B, E = i("VU/8")(I, k, !1, function(t) {
                i("Cl0O")
            }, null, null).exports,
            L = i("//Fk"),
            T = i.n(L),
            ...
            M = i.n(U);
        i("K1Kb");
        "function" != typeof O.a && (Object.create = function(t) {
            function e() {}
            return e.prototype = t, new e
        }), A = M.a, P = window, document, B = {
                ...
                loadBlogTalkShort: function() {
                    return new T.a(function(t, e) {
                        st.loadBlogTalk(1).then(function(e) {
                            e.cnList.length <= 5 ? t(e.cnList) : t(e.cnList.slice(0, 5))
                        })
                    })
                },
                ...
                loadMyCommentList: function(t, e) {
                    return new T.a(function(i, n) {
                        var s = Math.ceil(e / 5),
                            a = 10 * parseInt((e - 1) % 5),
                            o = 10 * parseInt(e % 5);
                        o = o < a ? a + 10 : o, T.a.all([st.loadCommentList(t, s), st.loadCommentCount(t)]).then(function(t) {
                            i({
                                list: t[0].slice(a, o),
                                count: Math.ceil(t[1] / 10),
                                size: t[1],
                                current: e
                            })
                        })
                    ...
                    return it("/" + g.blogAcc + "/ajax/sidecolumn.aspx", function(t) {
                        var e = function(t, e) {
                            ...
                            s = t.find(".catListTag li a").map(function(t, i) {
                                ...
                                return n.num = parseInt(s[1].replace(")", "")), n
                            }),
                            a = {};
            ...
            ot = {
                ...
                methods: {
                    ...
                    musicPlay: function(t) {
                        try {
                            this.audio.src = t.url, this.audio.play() : this.audio.pause()) : this.musicPlayPos(), this.musicSetInfo(t), this.isPlay = !0, this.delayTime > 0 && (clearTimeout(this.delayTime), this.delayTime = 0)
                        } catch (t) {
                            this.musicError()
                        }
                    },
        ...
        var Lt = i("VU/8")(Bt, Et, !1, function(t) {
                i("r5eF")
            }, null, null).exports,
            Tt = i("c/Tr"),
            St = i.n(Tt),
        ...
        var $t = i("VU/8")({
            ...
            Ot = St()(Array(g.pageItemImgs - 1), function(t, e) {
                return e
            }).sort(function() {
            ...
            Ut = {
                ...
                methods: {
                    getRandomImgClz: function() {
                        var t = Ot.shift();
                        return Ot.push(t), "panel-item-pic-" + t
                    },
                    clickItem: function(t) {
        ...
        ! function(t, e, i) {
            ...
            e.emoji_index = 0, a.prototype = {
                _init: function() {
                    ...
                    var B = "544px",
                        E = t(e).width();
                    if (E < 544) switch (this.options.position) {
                        case "topLeft":
                        case "bottomLeft":
                            B = E - 2 * t(r).offset().right + "px";
                            break;
                        default:
                            B = E - 2 * t(r).offset().left + "px"
                    }
        ...
        var Yt = i("VU/8")(Wt, Qt, !1, function(t) {
                i("uGug")
            }, null, null).exports,
            Jt = (i("NknJ"), document),
            Zt = window,
            Xt = Jt.body,
            Kt = Jt.querySelector.bind(Jt),
            te = Jt.querySelectorAll.bind(Jt),
            ee = (Zt.requestAnimationFrame, /Mobile|Android|iOS|iPhone|iPad|iPod|Windows Phone|KFAPWI/i.test(navigator.userAgent)),
            ...
            de = function(t) {
                var e = function(t, e, i) {
                    if (t && !i) return Zt.getComputedStyle(t).getPropertyValue(e);
                    t.style[e] = i
                }(t, "position");
                return e && "static" !== e
            },
            me = Jt.documentElement.clientHeight,
            pe = "toc",
            he = "*[data-toc]",
            fe = {
                dom: he,
        ...
        ge.prototype = {
            megre: function() {
                ...
                if (ue(t)) {
                    ...
                    if (i && i !== Xt)
                        if (ce(i)) this.options.offsetBody = de(i) ? i : Xt;
                        else if (le(i)) {
                        var n = function(t) {
                            try {
                                return Kt(t)
                        ...
                        this.options.offsetBody = n && n !== Xt && de(i) ? n : Xt
                    } else this.options.offsetBody = Xt;
                    else this.options.offsetBody = Xt;
            ...
            winEvents: function() {
                var t = this;
                Zt.addEventListener(ae, function() {
                    me = Jt.documentElement.clientHeight, t.debounce(t.setTocScroll, 200).call(t)
                })
            },
            ...
            addOffsetBodyScrollEvent: function() {
                (this.options.offsetBody === Xt ? Zt : this.options.offsetBody).addEventListener("scroll", this.events[0])
            },
            removeOffsetBodyScrollEvent: function() {
                (this.options.offsetBody === Xt ? Zt : this.options.offsetBody).removeEventListener("scroll", this.events[0])
            },
            ...
            getOffsetBodyScrollTop: function() {
                ...
                return t === Zt ? t.pageYOffset : t === Xt ? Jt.documentElement.scrollTop || Xt.scrollTop : t.scrollTop
            },
            GID: function() {
                var t = 0,
            ...
            getOffsetY: function(t) {
                var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : Xt,
                    i = t.offsetTop;
            ...
            loadHeadings: function() {
                ...
                n.forEach(function(e, n, a) {
                    ...
                    var c = function(e, i) {
                        ...
                        return n || ((n = Jt.createElement("a")).href = "#" + e.id, n.classList.add(t.options.classNames.link), i >= 2 && n.classList.add("" + t.options.classNames["marginLeft" + (i - 1)]), n.textContent = e.textContent), n
                    }(e, o);
        ...
        var Ee = i("VU/8")(Pe, Be, !1, function(t) {
                i("4n8e")
            }, null, null).exports,
            Le = {
                render: function() {
        ...
        var Ue = i("VU/8")($e, Oe, !1, function(t) {
                i("gp1v")
            }, null, null).exports,
            Me = {
                name: "BlogFullPage",
        ...
        var Qe = i("VU/8")(ze, We, !1, function(t) {
            ...
            Ye = {
                ...
                methods: {
                    ...
                    addToWz: function() {
                        return z(this.articleObj.pageId)
                    }
                },
                mounted: function() {
                    this.initPageList()
        ...
        var Ze = i("VU/8")(Ye, Je, !1, function(t) {
                i("DR4t")
            }, null, null).exports,
            Xe = {
                props: {
        ...
        var ti = i("VU/8")(Xe, Ke, !1, function(t) {
                i("HWat")
            }, null, null).exports,
            ei = {
                name: "Pagination",
                ...
                methods: {
                    ...
                    initMyCommentList: function(t, e) {
                        ...
                        this.pageNum = e, this.$bus.emit("barLoadingOpen"), at.loadMyCommentList(t, e).then(function(t) {
                            i.messageList = t.list, i.messageList.each(function(t, e) {
                                e.desc = Vt(e.desc)
                    ...
                    askIngList: function(t) {
                        ...
                        return t && this.$bus.emit("barLoadingOpen"), new T.a(function(n, s) {
                            at.loadBlogTalk(e.current).then(function(s) {
                                i.ingObj = s, t && e.$bus.emit("barLoadingClose"), n()
                            }).catch(function() {
                                n()
                            })
                        })
        ...
        var hi = i("VU/8")(mi, pi, !1, function(t) {
                ...
                data: function() {
                    return {
                        emailImg: G("/img/ing/email.png"),
                        qqImg: G("/img/ing/qq.png"),
                        githubImg: G("/img/ing/github.png"),
        ...
        (window.currentBlogApp = window.currentBlogApp || "cjunn", window.currentBlogId = window.currentBlogId || "571504", new T.a(function(t, e) {
            ...
            n.a.config.productionTip = !1, n.a.use(wi.a), n.a.prototype.VUE_CTX = "/c", n.a.directive("highlight", function(t) {
                ...
                beforeCreate: function() {
                    J(), yi.beforeEach(function(t, e, i) {
                        Z(t.fullPath), i()
                    })
                },
                mounted: function() {
